...
<body>
    ...
    <div id="label-layout">
        ...
        <div>
            ...
            <div class="item-code">FD-PD-SL-36147A</div>
        <br>
        ...
        <div id="FD-PD-SL-36147A">
            <table class="layout-table">
                ...
                <tbody>
                    <tr>
                        <td>
                            <div class="FD-PD-SL-36147A-front">
                                <div class="FD-PD-SL-36147A-box1"></div>

                                <img src="/images/pdf/FD-PD-SL-36147A.jpg">

                                <div class="FD-PD-SL-36147A-box3">
                                    <div class="FD-PD-SL-36147A-size-header">SIZE/TALLA:</div>
                                    <div class="FD-PD-SL-36147A-size">${size}</div>

                                    <div class="FD-PD-SL-36147A-box5">
                                        ...
                                        <div class="FD-PD-SL-36147A-for-care">SEE REVERSE FOR CARE</div>
                                       ...
                                       % for ct in format_fibers(data)['sp']:
                                        ...
                                        <div class="FD-PD-SL-36147A-for-care">VE EL REVERSO PARA EL CUIDADO</div>
                                    </div>
                                </div>
                        ...
                        <td>
                            <div class="FD-PD-SL-36147A-back">
                                <div class="FD-PD-SL-36147A-box2">
                                    <br>
                                    <div class="FD-PD-SL-36147A-care">
