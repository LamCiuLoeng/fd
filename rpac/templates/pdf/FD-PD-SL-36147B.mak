...
<body>
    ...
    <div id="label-layout">
        ...
        <div>
            ...
            <div class="item-code">FD-PD-SL-36147B</div>
        <br>
        ...
        <div id="FD-PD-SL-36147B">
            <table class="layout-table">
                ...
                <tbody>
                    <tr>
                        <td>
                            <div class="FD-PD-SL-36147B-front">
                                <div class="FD-PD-SL-36147B-box1"></div>

                                <img src="/images/pdf/FD-PD-SL-36147B.jpg">

                                <div class="FD-PD-SL-36147B-box3">
                                    <div class="FD-PD-SL-36147B-size-header">SIZE/TALLA:</div>
                                    <div class="FD-PD-SL-36147B-size">${size}</div>
                                    ...
                                    <div class="FD-PD-SL-36147B-for-care">SEE REVERSE FOR CARE</div>
                        ...
                        <td>
                            <div class="FD-PD-SL-36147B-back">
                                <div class="FD-PD-SL-36147B-box2">
                                    <div class="FD-PD-SL-36147B-care">
