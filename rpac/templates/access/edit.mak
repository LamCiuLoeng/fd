...
<div class="nav-tree">Access&nbsp;&nbsp;&gt;&nbsp;&nbsp;Edit</div>

<div style="margin: 10px 0px; overflow: hidden;">
  <div style="float: left;">
    %if values.get('type',None) == "user":
        <div>
          <form name="userForm" class="tableform" method="post" action="/access/save_edit">
          	<input type="hidden" name="type" value="user"/>
          	<input type="hidden" name="id" value="${values.get('user_id')}"/>
            <div class="case-list-one">
              <div class="case-list">
                ...
                <ul>
                  ...
                  <li>
                    <table>
                    %for g in values.get('options',[]):
                        <tr>
                            <td><input type="checkbox" name="groups" value="${g.group_id}" ${tw.attrs([('checked',g.group_id in values.get('groups',[])),])} style="width:30px"/></td>
                            <td>&nbsp;${g}&nbsp;</td>
                        </tr>                        
                    %endfor
                    </table>
    ...
    %elif values.get('type',None) =="group":
    <div>
      <form name="groupForm" class="tableform" method="post" action="/access/save_edit">
      	<input type="hidden" name="type" value="group"/>
      	<input type="hidden" name="id" value="${values.get('group_id','')}"/>
        <div class="case-list-one">
          <div class="case-list">
            <ul>
              <li class="label">
              ...
              <li>
                <input type="text" id="groupForm_group_name" name="group_name" class="textfield" style="width: 250px;" value="${values.get('group_name','')}"/>
              </li>
            </ul>
          </div>
        </div>
        <div class="case-list-one">
          <div class="case-list">
            <ul>
              ...
              <li>
                <input type="text" id="groupForm_display_name" name="display_name" class="textfield" style="width: 250px;" value="${values.get('display_name','')}"/>
              </li>
            </ul>
          </div>
        </div>
