            ...
            <div class="case-list-one">
              <div class="case-list">
                <ul>
                  ...
                  <li>
                    <input type="text" id="form1_value" name="value" class="textfield" style="width: 250px;"/>
                  </li>
                </ul>            
              </div>
            </div>
            ...
            <div class="case-list-one">
              <div class="case-list">
                <ul>
                  ...
                  <li>
                    <input type="text" id="form2_english" name="english" class="textfield" style="width: 250px;"/>
                  </li>
                </ul>
              </div>
            </div>
            <div class="case-list-one">
              <div class="case-list">
                <ul>
                  ...
                  <li>
                    <input type="text" id="form2_spanish" name="spanish" class="textfield" style="width: 250px;"/>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div class="case-list-one">
              <div class="case-list">
                <ul>
                  ...
                  <li>
                    <input type="text" id="form3_english" name="english" class="textfield" style="width: 250px;"/>
                  </li>
                </ul>
                <ul>
                  <li class="label">
            ...
            <div class="case-list-one">
              <div class="case-list">
                <ul>
                  ...
                  <li>
                    <input type="text" id="form3_spanish" name="spanish" class="textfield" style="width: 250px;"/>
                  </li>
                </ul>
              </div>
            </div>
